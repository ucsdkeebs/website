    ...
    return (
        ...
        <div className="event-details">
          ...
          <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className={styles.info_item_text}>
              <span className={styles.title}> 06 January 2023</span>
              <span className={styles.under}> Saturday, 12:00PM – 3:00PM</span>
            </div>
          </div>
          ...
          <div className={styles.info_item}>
              ...
              <div className={styles.info_item_text}>
              <span className={styles.title}> East Ballroom Price Center</span>
              <span className={styles.under}>3135 Matthews Ln, La Jolla, CA 92093</span>
            </div>
          </div>
          ...
          <div className={styles.info_item}>
            ...
            <div className={styles.info_item_text}>
              <span className={styles.title}> Registration is CLOSED</span>
              <a href="https://eventbrite-link" className={styles.under}> Click here for Eventbrite link</a>
            </div>
          </div>
        </div>
